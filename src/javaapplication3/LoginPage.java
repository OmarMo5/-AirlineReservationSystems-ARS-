...
import javax.swing.*;
import javaapplication3.Client.*;
import java.io.*;
...
public class LoginPage extends JFrame implements ActionListener {
    ...
    private static int corCount = Runtime.getRuntime().availableProcessors();

    private File fileManger = new java.io.File("F:\\DataForMy\\CV & Projects\\Some Project In Faculty\\Project ARS\\users.txt");
    ...
    public LoginPage() {
        ...
        service = Executors.newFixedThreadPool(corCount);
        this.setTitle("LOGIN");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == loginButton) {
            ...
            try {
                ...
                if (userNameFromFile.contains(userName) && passwordFromFile.contains(password)) {
                    JOptionPane.showMessageDialog(null, "Welcome Here!", "Message", JOptionPane.ERROR_MESSAGE);
        ...
        if (e.getSource() == registerEnsureButton) {
            ...
            if (userNameRegister.equals("") && passRegister.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "Successful registration", "Success", JOptionPane.ERROR_MESSAGE);
                service.execute(new Client(oneServer));
                ...
                if (!fileManger.exists()) {
                    ...
                    try {
                        ...
                        newUser = new PrintWriter(fileManger);
    ...
    public ArrayList<String> GetUsersNamefromFile() throws FileNotFoundException {
        ...
        Scanner values = new Scanner(fileManger);
        if (!fileManger.exists()) {
            System.out.println("the file not exit ");
        } else {
